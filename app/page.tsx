...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex shrink-0  items-center justify-center  bg-blue-600 p-4 md:h-30">
        <DakshClassesLogo />
      </div>
      ...
      <div className="h-56 grid grid-cols-3 gap-4 content-start flex shrink-0 items-end  bg-blue-600 p-4 md:h-10">
        ...
        {/* <div>
          <Link
            href="/login"
            className="flex items-center gap-5 rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-red-400 md:text-base"
          >
