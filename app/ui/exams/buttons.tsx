import { CalendarDaysIcon, CurrencyDollarIcon, PencilIcon, PlusIcon, TrashIcon } from '@heroicons/react/24/outline';
...
export function CreateStudent() {
  return (
    ...
    >
      <span className="hidden md:block">Create Exam</span>{' '}
